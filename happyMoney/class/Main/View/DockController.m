...
@interface DockController () <DockDelegate,LoginDelegate>
@end
...
{
    [self dock:_dock itemSelectedFrom:_dock.selectedIndex to:type];
    [_dock changeItemFrom:_dock.selectedIndex to:type];
}
