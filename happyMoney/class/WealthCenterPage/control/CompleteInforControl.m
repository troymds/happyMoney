//
//  CompleteInforControl.m
//  happyMoney
//
//  Created by promo on 15-6-3.
...
@interface CompleteInforControl ()<UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
{
    CGFloat _viewH;
...
@implementation CompleteInforControl
...
-(void)modefy
{
    ...
    {
        [RemindView showViewWithTitle:@"请填写支付宝信息!" location:MIDDLE];
    }
}
