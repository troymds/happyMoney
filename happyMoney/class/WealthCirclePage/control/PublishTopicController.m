...
- (void)uploadImage:(UIImage *)img
{
    ...
    NSDictionary *param = [NSDictionary dictionaryWithObjectsAndKeys:string,@"image",content,@"content", nil];
    
    [HttpTool postWithPath:@"publishTopic" params:param success:^(id JSON, int code) {
...
- (void)uploadContent:(NSString *)data
{
    ...
    NSDictionary *param = [NSDictionary dictionaryWithObjectsAndKeys:@"",@"image",content,@"content", nil];
