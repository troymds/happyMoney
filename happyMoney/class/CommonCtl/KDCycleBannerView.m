...
- (void)initializePageControl {
    ...
    _pageControl = [[UIPageControl alloc] initWithFrame:pageControlFrame];
     ...
     _pageControl.frame=CGRectMake(20, _scrollView.frame.size.height-25, _scrollView.frame.size.width-20, 20);
...
- (void)loadData {
    ...
    _pageControl.currentPageIndicatorTintColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"首页2_05"]];
    _pageControl.pageIndicatorTintColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"首页2_03"]];
...
//                [imageView setImage:[UIImage imageNamed:imageSource]];
            }else {
